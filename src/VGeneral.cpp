...
// Imprime una cadena de caracteres justificada
void VGeneral :: ImprimirCadenaJustificada(string msj, int espacio)
{
     cout << setw(espacio) << msj;
}
...
void VGeneral::ImprimirString(string msj, string s, int espacio) {
	  cout << setw(espacio) << s;
}
